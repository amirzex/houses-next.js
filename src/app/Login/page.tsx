...
import google from '../../assets/register/icons8-google-48.png'
import apple from '../../assets/register/icons8-apple-50.png'
...
const Login = () => {
  return (
    <div className='w-full flex flex-row-reverse items-center justify-center p-15 gap-10'>
      {/* right div */}
      <div className='w-[35%] flex flex-col bg-white shadow-black shadow-sm text-right rounded-4xl p-5 '>
        {/* top */}
        ...
        <div className='w-full flex flex-col gap-2 '>
          <h2 className='font-black text-2xl w-full'>  ورود به حساب کاربری   </h2>
          <p className='w-full'>  برای دسترسی به خدمات و تجربه بهتر از سایت وارد حساب خود شوید   </p>
        </div>
        {/* form */}
        <div className='w-full mt-7 mb-10'>
          <form className='w-full flex flex-col gap-5 ' action="">
            ...
            <a className='text-blue-500' href="Forget">  رمز عبور خود را فراموش کرده اید؟ </a>
            <button className='bg-blue-900 text-white p-3 rounded-4xl'> ورود به حساب کاربری  </button>
          </form>
        ...
        <div className=' flex flex-col gap-10 w-full'>
          ...
          <div className='w-full flex flex-row justify-center items-center '>
            <div className='border w-[47%]'></div>
            <div className='w-[5%] text-center'> یا </div>
            <div className='border w-[47%]'></div>
          </div>
          {/* apple $ google Login */}
          <div className='w-full flex flex-row-reverse gap-5 justify-center items-center '>
            <Link href={"/Register"} className='w-[50%] flex justify-center items-center gap-3 text-center border-2 p-3 rounded-4xl cursor-pointer'>
              <p> ورود با استفاده از گوگل</p>
              <Image
                src={google}
                width={30}
                alt="landing background"
          ...
          <div className='text-center mb-20'>
            <p> حساب کاربری ندارید؟ <Link className='text-blue-400' href="/Register">ثبت نام کنید</Link></p>
          </div>
        </div>
      </div>
      {/* left side */}
