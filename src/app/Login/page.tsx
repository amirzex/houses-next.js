...
// عکس اصلی خانه را وارد کنید، بقیه آیکون‌ها با SVG جایگزین شدند تا شبیه عکس شوند
import apartment from '../../assets/register/modern-tokyo-street-background_23-2149394920.avif';

const Login = () => {
  return (
    // کانتینر اصلی - تنظیم شده برای زبان فارسی (RTL)
