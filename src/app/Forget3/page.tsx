    ...
    return (
        <div className='w-full flex flex-row-reverse items-center justify-center p-15 gap-10'>
            ...
            <div className='w-[35%] h-197 flex flex-col justify-center bg-white shadow-black shadow-sm text-right rounded-4xl p-5 '>
                {/* top */}
                <Link className='mb-5 mt-20 flex flex-row-reverse items-center gap-1 text-blue-900' href={'Forget'}>
                    <Image
                        src={arrow}
                        width={18}
                ...
                <div className='w-full flex flex-col gap-2 '>
                    <h2 className='font-black text-2xl w-full'>  فراموشی رمز عبور  (مرحله آخر)     </h2>
                    <p className='w-full'> رمز عبور خود را ایجاد کن و راحت وارد حساب کابریت شو </p>
                </div>
                {/* form */}
