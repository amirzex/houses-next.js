...
const Facilities = () => {
    return (
        <div className=' w-full flex flex-row flex-wrap gap-5 p-10'>
            ...
            <div className='w-[30%] bg-[#FFFFFA]  rounded-2xl  p-3 flex flex-col gap-1 justify-center items-center border border-gray-300 hover:border-r-6 hover:border-blue-900 transition-all duration-200 hover:bg-blue-100'>
