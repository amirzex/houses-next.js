...
const Category = () => {
    return (
        <div className='w-full flex flex-col text-right mt-30 p-10 gap-10'>
            <div className=' w-full flex flex-col gap-4 text-center '>
                <p className='text-blue-700 text-2xl'>فقط بگرد و پیدا کن</p>
                <p className='text-4xl'>هر ملکی بخوای اینجا پیدا میشه!</p>
            </div>
