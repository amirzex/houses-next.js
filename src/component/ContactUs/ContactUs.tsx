...
const ContactUs = () => {
    // مختصات رشت برای نمایش روی نقشه
    ...
    return (
        <div className='flex flex-col w-full px-15 max-sm:px-5 gap-16 font-sans text-gray-800' dir="rtl">
            ...
            {/* بخش بالایی: متن و اطلاعات تماس */}
            <div className='w-full flex flex-col md:flex-row justify-between items-center gap-10'>
                {/* سمت راست: عنوان و توضیحات */}
                <div className='w-full md:w-[60%] flex flex-col gap-6'>
                    <h2 className="text-3xl md:text-4xl max-sm:text-2xl font-black text-black leading-tight">
                ...
                {/* سمت چپ: باکس‌های اطلاعات تماس */}
                <div className='w-full md:w-[40%] flex flex-col  gap-4 items-start'>
                    {/* آدرس */}
                    <div className="flex flex-row-reverse items-center justify-center w-[80%] max-sm:w-full bg-white p-4 rounded-3xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] border-r-4 border-[#1a3b99]">
            ...
            {/* بخش پایینی: فرم و نقشه */}
            <div className="w-full flex flex-col gap-8">
                {/* تیتر وسط */}
                <div className="text-center flex flex-col gap-2">
                    <span className="text-[#1a3b99] font-bold text-sm">برای بهترین تجربه</span>
                    <h3 className="text-2xl md:text-3xl font-black">نظرات خود را به ما بگید</h3>
                </div>

                {/* کانتینر اصلی فرم و نقشه */}
